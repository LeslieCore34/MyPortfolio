  ...
  return (
    <div className="project-container" id="#section-projects">
      ...
      <p className="project-description">
        ...
        and styled using SCSS. To facilitate communication with the backend, we
        implemented a REST API using the Express framework on Node.js. The
        project utilizes a MySQL database for data storage.
      </p>
